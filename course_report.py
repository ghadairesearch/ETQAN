...
EN_TRANSLATIONS = {
    ...
    'home.reviewer_level_description': 'Tools for academic reviewers to check reports, mappings, and accreditation evidence.',
...
TRANSLATIONS = {
    'ar': {
        ...
        'home.reviewer_level_description': 'أدوات لمساعدة المراجعين على فحص التقارير والربط وأدلة الاعتماد.',
