...
COURSE_IMPROVEMENT_RECOMMENDATIONS = [
    ...
    'Increase use of digital technologies and AI',
    'Increase self-directed learning opportunities',
    'Introduce a practical component to the course',
    'Enhance use of LMS platforms',
    'Integrate AI tools into the teaching process',
    'Increase use of simulations and specialized software',
    'Develop e-learning content',
    'Produce interactive digital learning resources',
]
COURSE_IMPROVEMENT_RECOMMENDATION_GROUPS = [
    ...
    {
        'heading': 'Digital Technologies and Learning Resources',
        'items': [
            'Enhance use of LMS platforms',
            'Integrate AI tools into the teaching process',
            'Increase use of simulations and specialized software',
...
COURSE_REPORT_AR_LABELS = {
    ...
    'Digital Technologies and Learning Resources': 'التقنيات والموارد الرقمية',
    'Other': 'أخرى',
    'Enhance use of LMS platforms': 'تعزيز استخدام أنظمة إدارة التعلم (LMS)',
    'Integrate AI tools into the teaching process': 'دمج أدوات الذكاء الاصطناعي في العملية التعليمية',
    'Increase use of simulations and specialized software': 'زيادة استخدام المحاكاة والبرمجيات التخصصية',
    'Develop e-learning content': 'تطوير المحتوى الإلكتروني',
    'Produce interactive digital learning resources': 'إنتاج موارد تعليمية رقمية تفاعلية',
    ...
    'Improve assessment methods': 'تحسين آليات قياس نواتج التعلم',
    ...
    'Introduce a practical component to the course': 'استحداث جانب عملي للمقرر',
    ...
    'Increase use of digital technologies and AI': 'زيادة استخدام التقنيات الرقمية والذكاء الاصطناعي',
    'Increase self-directed learning opportunities': 'زيادة فرص التعلم الذاتي',
    'Improve course materials and resources': 'تحسين موارد ومصادر التعلم',
    ...
    'Enhance research skills': 'تعزيز مهارات البحث العلمي',
    'Enhance professional and ethical skills': 'تعزيز المهارات المهنية والأخلاقية',
    ...
    'Other': 'أخرى',
    'Diversify teaching methods': 'تنويع أساليب التدريس',
    'Increase classroom activities': 'زيادة الأنشطة الصفية',
    'Provide additional exercises and activities': 'توفير تمارين وأنشطة إضافية',
    'Enhance student feedback': 'تعزيز التغذية الراجعة للطلاب',
    'Conduct academic support and advising sessions': 'تنفيذ جلسات دعم وإرشاد أكاديمي',
    'Redesign assessment tools': 'إعادة تصميم أدوات التقييم',
    'Diversify assessment methods': 'تنويع أساليب التقييم',
    'Build a question bank': 'بناء بنك أسئلة',
    'Update exam questions': 'تحديث أسئلة الاختبارات',
    'Update CLO-assessment mapping matrix': 'تحديث جدول الربط بين نواتج التعلم وأدوات التقييم',
    'Add application activities': 'إضافة أنشطة تطبيقية',
    'Update practical/lab manuals': 'تحديث الأدلة العملية',
    'Update course specification': 'تحديث توصيف المقرر',
    'Add practical/lab hours': 'إضافة ساعات عملية',
    'Design new projects': 'تصميم مشاريع جديدة',
    'Prepare assessment rubrics': 'إعداد Rubrics',
    'Allocate project time': 'تخصيص وقت للمشروع',
    'Add case studies': 'إضافة دراسات حالة',
    'Develop analytical activities': 'تطوير أنشطة تحليلية',
    'Engage industry experts': 'إشراك خبراء من سوق العمل',
    'Engage employers': 'إشراك أصحاب العمل',
    'Review required skills': 'مراجعة المهارات المطلوبة',
    'Update topics': 'تحديث الموضوعات',
    'Add modern technologies': 'إضافة تقنيات حديثة',
    'Update references': 'تحديث المراجع',
    'Add practical examples': 'إضافة أمثلة عملية',
    'Integrate applications and software': 'دمج تطبيقات وبرمجيات',
    'Develop applied exercises': 'تطوير تمارين تطبيقية',
    'Update textbook references': 'تحديث الكتب',
    'Add online/electronic resources': 'إضافة مصادر إلكترونية',
    'Develop digital content': 'تطوير المحتوى الرقمي',
    'Reorder topics': 'إعادة ترتيب الموضوعات',
    'Review topic time schedule': 'مراجعة الخطة الزمنية',
    'Study course workload': 'دراسة عبء المقرر',
    'Amend specification': 'تعديل التوصيف',
    'Upload all course materials to LMS': 'رفع جميع المواد على النظام',
    'Create online/electronic quizzes': 'إنشاء اختبارات إلكترونية',
    'Utilize discussion forums': 'استخدام المنتديات',
    'Use AI tools in learning activities': 'استخدام أدوات الذكاء الاصطناعي في الأنشطة',
    'Design AI-supported tasks': 'تصميم مهام مدعومة بالذكاء الاصطناعي',
    'Update AI usage policies': 'تحديث سياسات الاستخدام',
    'Adopt new software': 'اعتماد برمجيات جديدة',
    'Design simulation activities': 'تصميم أنشطة محاكاة',
    'Create educational videos': 'إنشاء فيديوهات تعليمية',
    'Develop electronic modules': 'تطوير وحدات إلكترونية',
    'Update content on LMS': 'تحديث المحتوى على نظام إدارة التعلم',
    'Design interactive activities': 'تصميم أنشطة تفاعلية',
    'Build question banks': 'إنشاء بنوك أسئلة',
    'Develop multimedia resources': 'تطوير وسائط متعددة',
    'Add analytical questions': 'إضافة أسئلة تحليلية',
    'Organize classroom discussions': 'تنظيم مناقشات صفية',
    'Design problem-solving activities': 'تصميم أنشطة قائمة على حل المشكلات',
    'Design group projects': 'تصميم مشاريع جماعية',
    'Organize presentations': 'تنظيم عروض تقديمية',
    'Apply peer assessment': 'تطبيق تقييم الأقران',
    'Reduce topic count': 'تقليل عدد الموضوعات',
    'Review course content': 'مراجعة محتوى المقرر',
    'Adjust topic sequencing': 'تعديل تسلسل الموضوعات',
    'Assign research topics': 'تكليف بموضوعات بحثية',
    'Conduct literature search training': 'التدريب على البحث في الأدبيات',
    'Provide research guidelines': 'توفير أدلة إرشادية للبحث',
...
COURSE_IMPROVEMENT_RECOMMENDATION_ACTIONS = {
    ...
    'Introduce a practical component to the course': [
        'Update course specification',
        'Add practical/lab hours',
        'Increase practical/application activities',
        'Coordinate with the department/course team',
        'Monitor implementation in the next offering',
        'Other',
    ...
    'Increase applied activities and problem-solving': [
        ...
        'Integrate applications and software',
        'Develop applied exercises',
        'Increase practical/application activities',
        'Provide supplementary learning resources',
        'Coordinate with the department/course team',
        'Monitor implementation in the next offering',
    ...
    'Improve course materials and resources': [
        'Update textbook references',
        'Add online/electronic resources',
    ...
    'Enhance use of LMS platforms': [
        'Upload all course materials to LMS',
        'Create online/electronic quizzes',
    ...
    'Integrate AI tools into the teaching process': [
        'Use AI tools in learning activities',
        'Design AI-supported tasks',
    ...
    'Enhance research skills': [
        ...
        'Conduct literature search training',
...
COURSE_IMPROVEMENT_ACTION_OPTIONS = list({
    action
...
EN_TRANSLATIONS = {
    ...
    'method.rule_based': 'Rule-based parsing',
    'method.ai_extraction': 'AI Extraction',
...
TRANSLATIONS = {
    'ar': {
        ...
        'courses.manual_prompt': 'أو هل ترغب في إدخال بيانات المقرر يدوياً؟',
        'courses.manual_method': 'بيانات المقرر',
        'courses.manual_help': 'استخدم هذه الطريقة إذا لم يكن لديك توصيف المقرر أو أردت تعديل البيانات المستخرجة آليا من التوصيف.',
        ...
        'method.rule_based': 'استخراج مبني على القواعد (Rule-based)',
        'method.ai_extraction': 'استخراج بالذكاء الاصطناعي',
        'courses.extraction_method_gemini': 'Gemini Flash',
        'courses.extraction_method_qwen': 'Qwen via Groq',
