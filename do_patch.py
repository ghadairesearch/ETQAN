...
# We want to replace everything from "def build_course_report_word_identity_blocks" to the end of the function.
# The end of the function is just before "def insert_course_report_word_identity"
pattern = re.compile(r"(def build_course_report_word_identity_blocks.*?)(?=\ndef insert_course_report_word_identity)", re.DOTALL)
